...
command=matrix(c( 
  ...
  "sampleType",     "t",1, "character", "the path of gene and fold-change",
  "tumor_purity_method", "p", 1, "character", "the path of gene and fold-change",
  "dataset",       "d", 1, "character", "dataset ID",
  "sign",          "s", 1, "character", "the work path for reading and saving data",
  "num_gene",      "n", 1, "character", "the path for saving result",
  "LINCS_type",    "l", 1, "character", "LINCS gene: 978genes or allgenes",
...
#   if(is.element(cancer_type,c("CHOL","DLBC","ESCA","MESO","PAAD","PCPG","SARC","STAD","TGCT","THYM", "UVM"))){
...
# LINCS_type = "allgenes"
    ...
    resPath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "_meta_oe_original/drug_immunesig_",tumor_purity_method, "_GSEA_result_files_978genes/")
    savePath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "_meta_oe_original/")
    # dir.create(savePath)
    dir.create(paste0(savePath, "/drug_immunesig_",tumor_purity_method, "_GSEA_result_all_978genes/"))
    dir.create(paste0(savePath, "/drug_immunesig_",tumor_purity_method, "_GSEA_result_summarized_978genes/"))
    savePath_allresult = paste0(savePath, "/drug_immunesig_",tumor_purity_method, "_GSEA_result_all_978genes/")
    saveAllPath_mergedresult = paste0(savePath, "/drug_immunesig_",tumor_purity_method, "_GSEA_result_summarized_978genes/")
...
#     resPath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/drug_immunesig_IHC_GSEA_result_files/")
#     savePath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/")
#     dir.create(savePath)
#     dir.create(paste0(savePath, "/drug_immunesig_IHC_GSEA_result_all/"))
#     dir.create(paste0(savePath, "/drug_immunesig_IHC_GSEA_result_summarized/"))
#     savePath_allresult = paste0(savePath, "/drug_immunesig_IHC_GSEA_result_all/")
#     saveAllPath_mergedresult = paste0(savePath, "/drug_immunesig_IHC_GSEA_result_summarized/")
...
# if(LINCS_type == "978genes"){
    
#     # plot together locally
#     resPath_978genes <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/drug_immunesig_none_GSEA_result_files_978genes/")
#     savePath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/")
#     dir.create(savePath)
#     dir.create(paste0(savePath, "/drug_immunesig_none_GSEA_result_all_978genes/"))
#     dir.create(paste0(savePath, "/drug_immunesig_none_GSEA_result_summarized_978genes/"))
#     savePath_allresult_978genes = paste0(savePath, "/drug_immunesig_none_GSEA_result_all_978genes/")
#     saveAllPath_mergedresult_978genes = paste0(savePath, "/drug_immunesig_none_GSEA_result_summarized_978genes/")
...
#       sign = sign,
#       num_gene = num_gene,
#       resPath = resPath_978genes,
#       savePath_allresult = savePath_allresult_978genes,
#       saveAllPath_mergedresult = saveAllPath_mergedresult_978genes
#     )
#   } 
# }else if(LINCS_type == "978genes"){
    
#     # plot together locally
#     resPath_978genes <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/drug_immunesig_IHC_GSEA_result_files_978genes/")
#     savePath <- paste0("p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_",tumor_purity_method, "/")
#     dir.create(savePath)
#     dir.create(paste0(savePath, "/drug_immunesig_IHC_GSEA_result_all_978genes/"))
#     dir.create(paste0(savePath, "/drug_immunesig_IHC_GSEA_result_summarized_978genes/"))
#     savePath_allresult_978genes = paste0(savePath, "/drug_immunesig_IHC_GSEA_result_all_978genes/")
#     saveAllPath_mergedresult_978genes = paste0(savePath, "/drug_immunesig_IHC_GSEA_result_summarized_978genes/")
