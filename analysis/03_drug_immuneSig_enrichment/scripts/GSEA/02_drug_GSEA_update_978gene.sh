...
exp=data/drug_treated_expression_978genes_matrix/${dataset}/${cancer}/
grp=data/drug_treated_design/for_GSEA/${dataset}/${cancer}/

mkdir ${wDir}/results_${tumor_purity_method}_meta_oe_original
mkdir ${wDir}/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_978genes
mkdir ${wDir}/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_978genes/${dataset}
outPath=results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_978genes/${dataset}/${cancer}_${sampleType}


mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_files_978genes
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_files_978genes/${dataset}
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_files_978genes/${dataset}/${cancer}_${sampleType}
desDir=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_${tumor_purity_method}_meta_oe_original/drug_immunesig_${tumor_purity_method}_GSEA_result_files_978genes/${dataset}/${cancer}_${sampleType}
