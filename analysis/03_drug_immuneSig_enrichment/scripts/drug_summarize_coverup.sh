...
sign2=positive
num_gene2=200
Rscript --vanilla 03_summarize_drug_immuneSig_GSEA.R -c ${cancer} -t ${sampleType} -p ${tumor_purity_method} -d ${dataset} -s ${sign2} -n ${num_gene2} -l allgenes > drug_summarize_${cancer}_${dataset}_${sign2}.log 2>&1 &
wait