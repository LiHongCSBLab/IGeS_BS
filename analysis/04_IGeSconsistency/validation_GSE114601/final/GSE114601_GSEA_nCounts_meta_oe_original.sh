...
exp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/immune_combo_dataset/GSE114601/GSE114601RNASeq_nCounts_gsea.txt
grp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/immune_combo_dataset/GSE114601/GSE114601RNASeq_nCounts_gsea.cls
...
# mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE114601
# mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE114601/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}
# mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE114601/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}/${dataset}
# outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE114601/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}/${dataset}/${cancer}_${sampleType}
outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE114601/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/
