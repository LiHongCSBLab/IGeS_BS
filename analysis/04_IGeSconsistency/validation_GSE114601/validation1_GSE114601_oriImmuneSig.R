...
count <- read.csv("data/immune_combo_dataset/GSE114601/counts.raw.csv", row.names = 1)
metadata <- data.frame(patient = names(count),
...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/GSE114601_yestoPD1treatment.csv"), row.names=1)
