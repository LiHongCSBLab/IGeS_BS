...
exp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/drug_pertubation_animal/GSE120500/GSE120500RNASeq_treatedVsvehicle_nCounts_gsea.txt
grp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/drug_pertubation_animal/GSE120500/GSE120500RNASeq_treatedVsvehicle_nCounts_gsea.cls
...
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE120500
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE120500/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original
outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE120500/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/
