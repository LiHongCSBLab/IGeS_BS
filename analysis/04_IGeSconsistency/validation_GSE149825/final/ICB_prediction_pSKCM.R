...
count_filtered = mat[rowSums(mat > 0) > 0.8 * ncol(mat), ]
...
library(GSVA)
load(paste0("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/02_tumorGene_immuneSig_correlation/results_selected/ITS_oe_original_spearman_",purity_method , "_r0.4/for_GSVA/pcor/pcor_spearman_",cancer,"_",tumor_subtype,"_positive_200.Rdata"))

# a=log2(tpm + 1)['SMAC_S3']
# a$gene=rownames(a)
# a=a[order(a$SMAC_S3, decreasing=T),]
# which(is.element(rownames(a), genelist_p$mhc_ips ))
# which(is.element(rownames(a), genelist_p$caf_tide ))
# which(is.element(rownames(a), genelist_p$m2_tide ))

pheatmap::pheatmap(tpm[is.element(rownames(tpm), genelist_p$mhc_ips ),],
scale='row',cluster_col=F)
# pheatmap::pheatmap(log2(tpm + 1)[is.element(rownames(log2(tpm + 1)), genelist_p$caf_tide ),],
# scale='row',cluster_col=F)

# pheatmap::pheatmap(data[[3]][is.element(rownames(data[[3]]), genelist_p$mhc_ips ),],
# scale='none',cluster_col=F)
...
dir.create("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/")
write.csv(ITS_p, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/ITS_SigScore.csv", quote=F, row.names=F)
ITS_p_selected = ITS_p[is.element(rownames(ITS_p),immunesig$immune_sig),]

write.csv(ITS_p_selected, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/ITS_SigScore_selected.csv", quote=F, row.names=F)
ITS_p_selected = as.data.frame(ITS_p_selected)
ITS_p_selected$immune_sig <- rownames(ITS_p_selected)
ITS_p_selected = inner_join(immunesig, ITS_p_selected)
a=ITS_p_selected[c(5:16)]*ITS_p_selected$weight
rownames(a) = ITS_p_selected$immune_sig
pheatmap::pheatmap(a,scale='none',cluster_col=F)
write.csv(ITS_p_selected, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/ITS_SigScore_selected_withweight.csv", quote=F, row.names=F)
...
pred_en$data$prob.1
write.csv(pred_en$data, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/ITS_prediction_prob.csv", quote=F, row.names=F)


# plot boxplot for the general score -------------------------------------------
# 1) plot for vehicle and SMAC
library(ggplot2)
library(ggpubr)
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/prediction_2group_boxplot.pdf", p, width=4, height=4)
...
p = ggplot(res, aes(group, prob.1, fill = group)) +
        ...
        stat_compare_means(method="t.test",hide.ns = F,
                            ...
                            bracket.size=0.5,
                            size=2.5)
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/prediction_boxplot_t.test_2group.pdf", p, width=4, height=4)


data_test$sample=rownames(data_test)
immuneSig_boxplot = lapply(as.list(names(data_test)[-c(58,59)]), function(x){
    # x = "mhc_ips"
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/singleITS_2group.pdf",
            width = 4,
            height = 4, 
            onefile = TRUE)
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/singleITS_t.test_2group.pdf",
            width = 4,
            height = 4, 
            onefile = TRUE)
for(x in seq(length(immuneSig_boxplot))){
...
p = ggplot(res, aes(group, prob.1, fill = group)) +
        ...
        geom_jitter(aes(fill=group), width=0.2, shape=21, size=2.5)+
        theme_bw()
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/prediction_boxplot.pdf", p, width=5, height=4)
...
p = ggplot(res, aes(group, prob.1, fill = group)) +
        ...
        stat_compare_means(method="t.test",hide.ns = F,
                            ...
                            bracket.size=0.5,
                            size=2.5)
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/prediction_boxplot_t.test.pdf", p, width=5, height=4)
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/singleITS.pdf",
            width = 5,
            height = 4, 
            onefile = TRUE)
for(x in seq(length(immuneSig_boxplot))){
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE149825/ICB_prediction_pSKCM/singleITS_t.test.pdf",
            width = 5,
            height = 4, 
            onefile = TRUE)
for(x in seq(length(immuneSig_boxplot))){
