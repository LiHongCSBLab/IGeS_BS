...
exp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/immune_combo_dataset/GSE152925/GSE152925RNASeq_treatedVsvehicle_nCounts_gsea.txt
grp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/immune_combo_dataset/GSE152925/GSE152925RNASeq_treatedVsvehicle_nCounts_gsea.cls


mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original
# mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/${dataset}
# outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/${dataset}/${cancer}_${sampleType}
outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/
...
nohup /picb/extprog/bin/linux-x86/java \
    ...
    -set_min 5 \
    -zip_report false \
    -gui false > GSE152925_treatedVsvehicle.log 2>& 1 &
