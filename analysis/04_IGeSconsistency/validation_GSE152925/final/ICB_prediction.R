...
dir.create("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/")
write.csv(ITS_p, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/ITS_SigScore.csv", quote=F, row.names=F)
# ------------------------------------------------------------------------------
...
pred_en$data$prob.1
write.csv(pred_en$data, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/ITS_prediction_prob.csv", quote=F, row.names=F)
...
metadata=metadata[c('description', 'treatment:ch1')]
names(metadata) = c('sample', 'label')
res=merge(res, metadata, by='sample')
res$label = factor(res$label, level=c("IgG +PBS","Swainsonine +IgG", "anti-PD-L1+PBS", "anti-PD-L1+Swainsonine"))
...
p = ggplot(res, aes(label, prob.1, fill = label)) +
        ...
        theme_bw()
# p
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/prediction_boxplot.pdf", p, width=5, height=4)

my_comparisons1 <- list(c("IgG +PBS", "Swainsonine +IgG")) 
my_comparisons2 <- list(c("IgG +PBS", "Swainsonine +IgG"))
my_comparisons3 <- list(c("IgG +PBS", "anti-PD-L1+Swainsonine"))
my_comparisons4 <- list(c("Swainsonine +IgG", "anti-PD-L1+PBS"))
my_comparisons5 <- list(c("Swainsonine +IgG", "anti-PD-L1+Swainsonine"))
my_comparisons6 <- list(c("anti-PD-L1+PBS", "anti-PD-L1+Swainsonine"))
...
p = ggplot(res, aes(label, prob.1, fill = label)) +
        ...
        stat_compare_means(method="t.test",hide.ns = F,
                            ...
                            bracket.size=0.5,
                            size=2.5)
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/prediction_boxplot_t.test.pdf", p, width=5, height=4)


data_test$sample=rownames(data_test)
data_test=merge(metadata,data_test)
data_test$label = factor(data_test$label,  level=c( "IgG +PBS" ,"Swainsonine +IgG","anti-PD-L1+PBS", "anti-PD-L1+Swainsonine"))
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/singleITS.pdf",
            width = 5,
            height = 4, 
            onefile = TRUE)
...
pdf("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/ICB_prediction/singleITS_t.test.pdf",
            width = 5,
            height = 4, 
            onefile = TRUE)
for(x in seq(length(immuneSig_boxplot))){
