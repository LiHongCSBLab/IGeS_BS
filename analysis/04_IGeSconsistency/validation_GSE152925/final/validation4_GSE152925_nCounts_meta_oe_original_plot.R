...
# drug_index "drug888" swainsonine
...
load("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/05_immuneSig_ICBresponse/results_r0.4_ITSssgsea_Combat/finalmodel_17datasets_ssgseanorm/metaAnalysis/en/elasticnet_model_pred.Rdata")
