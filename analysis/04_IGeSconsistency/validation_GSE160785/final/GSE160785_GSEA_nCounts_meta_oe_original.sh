...
# Try with DESeq2 corrected Count
...
# BMS-754807
exp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/drug_pertubation_animal/GSE160785/celecoxib_treatedVsvehicle_gsea_nCount.txt
grp=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/data/drug_pertubation_animal/GSE160785/celecoxib_treatedVsvehicle_gsea_nCount.cls

# mkdir ${wDir}/results_${tumor_purity_method}/
# mkdir ${wDir}/results_${tumor_purity_method}/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original
# mkdir ${wDir}/results_${tumor_purity_method}/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/${dataset}

mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE160785
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE160785/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original
mkdir /picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE160785/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/${cancer}_${sampleType}
outPath=/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE160785/drug_immunesig_${tumor_purity_method}_GSEA_result_r${s1}_meta_oe_original/${cancer}_${sampleType}
...
nohup /picb/extprog/bin/linux-x86/java \
    ...
    -set_min 5 \
    -zip_report false \
    -gui false > GSE160785_celecoxib_treatedVsvehicle.log 2>& 1 &
...
nohup /picb/extprog/bin/linux-x86/java \
    ...
    -set_min 5 \
    -zip_report false \
    -gui false > GSE160785_celecoxib_treatedVsvehicle_${cancer}.log 2>& 1 &
