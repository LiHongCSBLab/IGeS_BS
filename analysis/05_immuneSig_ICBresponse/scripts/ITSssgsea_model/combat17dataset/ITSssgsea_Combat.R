...
save(data, dataAnnot, file = "05_immuneSig_ICBresponse/results_r0.4_ITSssgsea_Combat/ICBdataset_Exp.Rdata")
...
ggsave(paste0(result_dir, "Exp_beforeCombat_pca.pdf"), p_beforeCombat, width = 15, height = 5)
...
ggsave(paste0(result_dir, "Exp_afterCombat_pca.pdf"), p_afterCombat, width = 15, height = 5)
...
savepath = paste0(result_dir, "ITSssgsea_beforeCombat/")
dir.create(savepath)
...
# after combat: data_ac
savepath = paste0(result_dir, "ITSssgsea_afterCombat/")
dir.create(savepath)
datasets = unique(dataAnnot_all$dataset)
data_ac <- t(data_ac)
for(dataset in datasets){
...
p_beforeCombat = p_dataset | p_cancer | p_label
ggsave(paste0(result_dir, "ITS_beforeCombat_ssgsea_pca.pdf"), p_beforeCombat, width = 15, height = 5)
...
p_beforeCombat = p_dataset | p_cancer | p_label
ggsave(paste0(result_dir, "ITS_beforeCombat_ssgseanorm_pca.pdf"), p_beforeCombat, width = 15, height = 5)
...
save(ITSres_selected, file = paste0(result_dir, "ITS_afterCombat_ssgsea.Rdata"))
...
p_afterCombat = p_dataset | p_cancer | p_label
ggsave(paste0(result_dir, "ITS_afterCombat_ssgsea_pca.pdf"), p_afterCombat, width = 15, height = 5)
...
save(ITSres_selected, file = paste0(result_dir, "ITS_afterCombat_ssgseanorm.Rdata"))
...
p_afterCombat = p_dataset | p_cancer | p_label
ggsave(paste0(result_dir, "ITS_afterCombat_ssgseanorm_pca.pdf"), p_afterCombat, width = 15, height = 5)
