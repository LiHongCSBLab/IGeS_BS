...
dir.create("07_plotting_v2/02_ITSprediction_removeprior_v3/")

result_dir <- "05_immuneSig_ICBresponse/results_r0.4_ITSssgsea_CombatRef/"
resultpath = paste0(result_dir, "finalmodel_17datasets_ssgseanorm/metaAnalysis_removeprior_v3/")
...
write.csv(vlSetName_auc_all, "07_plotting_v2/02_ITSprediction_removeprior_v3/vlSetName_auc_all.csv", quote = F, row.names = F)
write.csv(vlSetName_auc, "07_plotting_v2/02_ITSprediction_removeprior_v3/vlSetName_auc.csv", quote = F, row.names = F)
...
ggsave("07_plotting_v2/02_ITSprediction_removeprior_v3/fig_s2_vlSetName.pdf", p_s2b, width = 8, height = 6)
...
write.csv(singledataset_AUC_selected, "07_plotting_v2/02_ITSprediction_removeprior_v3/vlSetName_auc_otherModel.csv", quote = F)
...
ggsave("07_plotting_v2/02_ITSprediction_removeprior_v3/fig_2cd_vlSetName.pdf", p_fig2cd, width = 15, height = 18)
