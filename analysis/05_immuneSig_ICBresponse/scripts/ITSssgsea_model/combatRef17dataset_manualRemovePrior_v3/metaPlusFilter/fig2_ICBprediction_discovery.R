...
resultpath = paste0(result_dir, "modelCV_17datasets_ssgseanorm/metaAnalysis_filter_removeprior_v3/")
dir.create('07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/')
...
write.csv(cv_auc, "07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/cv_auc.csv", quote = F, row.names = F)
write.csv(discoverset_auc_all, "07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/discoverset_auc_all.csv", quote = F, row.names = F)
write.csv(discoverset_auc, "07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/discoverset_auc.csv", quote = F, row.names = F)
...
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/fig_s2_discoverySet.pdf", p_s2, width = 15, height = 8)
...
write.csv(singledataset_AUC, "07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/discoverySet_otherModel_all.csv", quote = F)
...
write.csv(singledataset_AUC_selected, "07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/discoverset_auc_otherModel.csv", quote = F)
...
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter_removeprior_v3/fig_2ab_discoverySet.pdf", p_fig2ab, width = 15, height = 18)
