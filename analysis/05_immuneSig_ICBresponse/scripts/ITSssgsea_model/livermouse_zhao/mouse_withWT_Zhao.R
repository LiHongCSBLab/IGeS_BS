...
result_dir <- "05_immuneSig_ICBresponse/results_mouse_withWT_ITSssgsea_CombatRef/"
...
data_mouse <- read.csv("05_immuneSig_ICBresponse/data/mouse_zhao/addNewSet/TPMmat_TPM.txt", sep = '\t', header = T, row.names = 1) 
...
mouseMetaInfo <- read.csv("05_immuneSig_ICBresponse/data/mouse_zhao/addNewSet/mMetadataMerged.csv")
