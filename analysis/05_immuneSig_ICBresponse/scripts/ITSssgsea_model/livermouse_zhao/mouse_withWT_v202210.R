...
result_dir <- "05_immuneSig_ICBresponse/results_mouse_withWT_v202210_ITSssgsea_CombatRef/"
...
data_mouse <- read.csv("05_immuneSig_ICBresponse/data/mouse_zhao/v202210/TPMmat_TPM.txt", sep = '\t', header = T, row.names = 1) 
...
mouseMetaInfo <- read.csv("05_immuneSig_ICBresponse/data/mouse_zhao/v202210/mMetadataMerged.csv")
...
pdf(paste0(savepath, "/metaAnalysis_filter/mouseITS_v202210_", enrich_method, "_IGeS.pdf"), 
    width = 15, height = 15)
...
ggsave(paste0(savepath, "/metaAnalysis_filter/mouseITS_v202210_", enrich_method, "_pred.pdf"), p, width = 10, height = 5)
write.csv(pred_mouse, paste0(savepath, "/metaAnalysis_filter/mouseITS_v202210_", enrich_method, "_enPred.csv"),
             row.names =F, quote = F)
...
data_test_selected <- data_test[c(intersect(features_selected, names(data_test)))]
pdf(paste0(savepath, "/metaAnalysis_filter_removeprior_v2/mouseITS_v202210_", enrich_method, "_IGeS.pdf"), 
    width = 15, height = 15)
pheatmap(data_test_selected, scale = 'column', 
         cluster_col = F,
         annotation_row = mouseMetaInfo["Genotype"],
...
p = ggplot(pred_mouse, aes(x=Genotype, y=prob.1)) +
      ...
      theme_bw()+   
      theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave(paste0(savepath, "/metaAnalysis_filter_removeprior_v2/mouseITS_v202210_", enrich_method, "_pred.pdf"), p, width = 10, height = 5)
write.csv(pred_mouse, paste0(savepath, "/metaAnalysis_filter_removeprior_v2/mouseITS_v202210_", enrich_method, "_enPred.csv"),
             row.names =F, quote = F)
...
features_selected <- sig_select[!is.element(sig_select$immune_sig, sig_filter_prior), ]$immune_sig
data_test_selected <- data_test[c(intersect(features_selected, names(data_test)))]
pdf(paste0(savepath, "/metaAnalysis_filter_removeprior_v3/mouseITS_v202210_", enrich_method, "_IGeS.pdf"), 
    width = 15, height = 15)
pheatmap(data_test_selected, scale = 'column', 
         cluster_col = F,
         annotation_row = mouseMetaInfo["Genotype"],
...
p = ggplot(pred_mouse, aes(x=Genotype, y=prob.1)) +
      ...
      theme_bw()+   
      theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave(paste0(savepath, "/metaAnalysis_filter_removeprior_v3/mouseITS_v202210_", enrich_method, "_pred.pdf"), p, width = 10, height = 5)
write.csv(pred_mouse, paste0(savepath, "/metaAnalysis_filter_removeprior_v3/mouseITS_v202210_", enrich_method, "_enPred.csv"),
             row.names =F, quote = F)
...
features_selected <- sig_select[!is.element(sig_select$immune_sig, sig_filter_prior), ]$immune_sig
data_test_selected <- data_test[c(intersect(features_selected, names(data_test)))]
pdf(paste0(savepath, "/metaAnalysis_filter_removeprior_v4/mouseITS_v202210_", enrich_method, "_IGeS.pdf"), 
    width = 15, height = 15)
pheatmap(data_test_selected, scale = 'column', 
         cluster_col = F,
         annotation_row = mouseMetaInfo["Genotype"],
...
p = ggplot(pred_mouse, aes(x=Genotype, y=prob.1)) +
      ...
      theme_bw()+   
      theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave(paste0(savepath, "/metaAnalysis_filter_removeprior_v4/mouseITS_v202210_", enrich_method, "_pred.pdf"), p, width = 10, height = 5)
write.csv(pred_mouse, paste0(savepath, "/metaAnalysis_filter_removeprior_v4/mouseITS_v202210_", enrich_method, "_enPred.csv"),
             row.names =F, quote = F)
