...
result_dir = "05_immuneSig_ICBresponse/validation_results/GSE115821_pre_outcome/"
...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/GSE115821_pre.csv"), row.names=1)
...
icb_compr(result = merged_res,
          ...
          filename = "GSE115821_pre_test_result.csv")



immuneSig_res <- read.csv("05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_test_results/GSE115821_pre_test_result.csv", row.names = 1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_all_results/GSE115821_pre_test_result.csv",
          row.names = F, quote = F)
...
write.csv(othermodel_auc, "05_immuneSig_ICBresponse/validation_results/GSE115821_othermodel_AUC.csv", quote = F, row.names = F)
