...
load("05_immuneSig_ICBresponse/results_r0.4_ITSssgsea_Combat/ICBdataset_Exp.Rdata")
...
result_dir = "05_immuneSig_ICBresponse/validation_results/GSE96619_outcome/"
...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/GSE96619.csv"), row.names=1)
...
icb_compr(result = merged_res,
          ...
          filename = "GSE96619_test_result.csv")



immuneSig_res <- read.csv("05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_test_results/GSE96619_test_result.csv", row.names = 1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_all_results/GSE96619_test_result.csv",
          row.names = F, quote = F)
...
write.csv(othermodel_auc, "05_immuneSig_ICBresponse/validation_results/GSE96619_othermodel_AUC.csv", quote = F, row.names = F)
