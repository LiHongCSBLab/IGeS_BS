...
response = response_CTLA4prior_MAPKTxNaive_skin[c('patient', 'label')]
...
result_dir = "05_immuneSig_ICBresponse/validation_results/Liu_dataset_/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/05_immuneSig_ICBresponse/scripts/scripts_for_icb_datasets/ICB_predictor_evaluation_metaAnalysis.R/"
...
expr4cibersort(expr = tpm_mat,
               dataset = "Liu_dataset_CTLA4treated",
...
icb_compr(result = merged_res,
          ...
          filename = "Liu_dataset_CTLA4treated_test_result.csv")
