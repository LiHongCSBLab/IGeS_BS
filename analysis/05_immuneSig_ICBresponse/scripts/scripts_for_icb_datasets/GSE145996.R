...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/GSE145996.csv"), row.names=1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/results/immunesig_icbResponse_all_results/GSE145996_test_result.csv",
          row.names = F, quote = F)
