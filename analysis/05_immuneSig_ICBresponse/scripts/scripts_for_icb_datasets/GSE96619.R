...
result_dir = "05_immuneSig_ICBresponse/results/GSE96619_outcome/"
...
immuneSig_res <- read.csv("05_immuneSig_ICBresponse/results/immunesig_icbResponse_test_results/GSE96619_test_result.csv", row.names = 1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/results/immunesig_icbResponse_all_results/GSE96619_test_result.csv",
          row.names = F, quote = F)
