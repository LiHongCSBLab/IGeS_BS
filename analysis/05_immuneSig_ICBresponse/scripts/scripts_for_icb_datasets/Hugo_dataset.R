...
# ITS_res_wilcox <- immuneSig_ITSgsva_cor_ICBdataset(data = tpm_mat,
#                                               response = response,
#                                               cancer = cancer, 
...
# write.csv(res, 
#           "05_immuneSig_ICBresponse/results/immunesig_icbResponse_all_results/01_Hugo_dataset_test_result.csv",
#           row.names = F, quote = F)
