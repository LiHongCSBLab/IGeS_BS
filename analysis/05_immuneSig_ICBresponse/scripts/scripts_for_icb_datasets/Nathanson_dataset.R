...
response$patient = as.character(response$patient )
...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/Nathanson_dataset.csv"), row.names=1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/results/immunesig_icbResponse_all_results/Nathanson_dataset_test_result.csv",
          row.names = F, quote = F)
