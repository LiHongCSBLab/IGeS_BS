...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/Zhao_dataset.csv"), row.names=1)
...
immuneSig_sig160_res$patient = gsub("X", "", immuneSig_sig160_res$patient)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/results/immunesig_icbResponse_all_results/Zhao_dataset_test_result.csv",
          row.names = F, quote = F)
