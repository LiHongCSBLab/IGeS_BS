...
result_dir = "05_immuneSig_ICBresponse/validation_results/08_Lauss_dataset_outcome/"
...
immuneSig_res <- read.csv("05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_test_results/08_Lauss_dataset_test_result.csv", row.names = 1)
...
write.csv(res, 
          "05_immuneSig_ICBresponse/validation_results/immunesig_icbResponse_all_results/08_Lauss_dataset_test_result.csv",
          row.names = F, quote = F)
...
write.csv(othermodel_auc, "05_immuneSig_ICBresponse/validation_results/lauss_othermodel_AUC.csv", quote = F, row.names = F)
