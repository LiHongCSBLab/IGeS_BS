...
result_dir = "05_immuneSig_ICBresponse/validation_results/Liu_dataset_CTLA4Naive/"
...
TIDEweb_res <- read.csv(paste0(result_dir, "TIDEweb/Liu_dataset.csv"), row.names=1)
...
# identify ICB predictive TME signatures ---------------------------------------
...
icb_compr(result = merged_res,
          ...
          filename = "Liu_dataset_CTLA4Naive_test_result.csv")




result_dir="05_immuneSig_ICBresponse/validation_results/Liu_dataset_CTLA4Naive_outcome/"
merged_res <- read.csv(paste0(result_dir, "/", cancer, "_", sample_type, "_immuneSig_merged.csv"))
...
write.csv(othermodel_auc, "05_immuneSig_ICBresponse/validation_results/liu_othermodel_AUC.csv", quote = F, row.names = F)
