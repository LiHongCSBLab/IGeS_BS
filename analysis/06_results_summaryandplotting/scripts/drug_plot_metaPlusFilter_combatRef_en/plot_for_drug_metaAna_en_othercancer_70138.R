...
cancerlist <- list.files("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_TUMERIC_meta_oe_original/drug_immunesig_TUMERIC_GSEA_result_summarized/70138/")
cancerlist <- cancerlist[grep("Primary", cancerlist)]
cancerlist <- gsub("_Primary","", cancerlist)
cancerlist <- cancerlist[-grep("LUAD", cancerlist)]
