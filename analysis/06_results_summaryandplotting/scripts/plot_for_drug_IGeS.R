...
dir.create(paste0("06_results_summaryandplotting/IGeSrename/"))
...
# dataset='70138'
cancerlist <- list.files(paste0("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/03_drug_immuneSig_enrichment/results_TUMERIC_meta_oe_original_final/drug_immunesig_TUMERIC_GSEA_result_summarized//", dataset))
cancerlist <- cancerlist[grep("Primary", cancerlist)]
cancerlist <- gsub("_Primary","", cancerlist)
# cancerlist <- cancerlist[-grep("LIHC", cancerlist)]
...
savepath = paste0("06_results_summaryandplotting/IGeSrename/", purity_method,"_", model,"_meta_en_ACATP",ACAT_Pval,"/") #
dir.create(savepath)
