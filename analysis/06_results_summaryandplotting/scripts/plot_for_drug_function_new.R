...
drugITSProfile <- function(df_immunesig,
  ...
  # IGeS_renaming    
  iges_rename <- openxlsx::read.xlsx("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/IGeS_Func_rename.xlsx")
...
drugITSscore_plot <- function(cancer = "LIHC",
                              ...
                              immunesig, 
                              model = c("m1", "m2"),
                              weight_type = c("model_weight", "meta_weight"),
                              type = c("unweighted", "weighted", "binary_weighted", "binary_unweighted"),
                              drugrank_method = c("glmnet_weight", "simple", "sum_mean"),
                              mergeITS = c('TRUE', 'FALSE'),
                              mergeITS_type = c('Type', 'Index'),
                              ACAT_Pval = 0.05,
                              ifProfile = FALSE, 
                              work_path = work_path,
