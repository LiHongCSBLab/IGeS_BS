...
immunesigAnnot = immunesigAnnot[order(immunesigAnnot$SubType_detail), ]
sig_cor = sig_cor[immunesigAnnot$immune_sig, immunesigAnnot$immune_sig]
pheatmap(sig_cor, 
         cluster_col = F, 
         cluster_row = F, 
         annotation_row = immunesigAnnot[c( 'SubType_detail','Type','flag')])
...
pheatmap(sig_cor[sigs_s$immune_sig, sigs_s$immune_sig], 
         cluster_col = T, 
         cluster_row = T, 
         annotation_row = immunesigAnnot[c( 'SubType_detail','Type','flag')])
