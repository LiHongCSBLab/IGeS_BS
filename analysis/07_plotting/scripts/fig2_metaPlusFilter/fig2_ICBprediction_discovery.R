...
dir.create("07_plotting_v2/02_ITSprediction_metaPlusFilter/")

result_dir <- "05_immuneSig_ICBresponse/results_r0.4_ITSssgsea_CombatRef/"
resultpath = paste0(result_dir, "modelCV_17datasets_ssgseanorm/metaAnalysis_filter/")
...
write.csv(cv_auc, "07_plotting_v2/02_ITSprediction_metaPlusFilter/cv_auc.csv", quote = F, row.names = F)
write.csv(discoverset_auc_all, "07_plotting_v2/02_ITSprediction_metaPlusFilter/discoverset_auc_all.csv", quote = F, row.names = F)
write.csv(discoverset_auc, "07_plotting_v2/02_ITSprediction_metaPlusFilter/discoverset_auc.csv", quote = F, row.names = F)
...
names(discoverset_roc_all)= c("ridge", "elastic net", "random forest", "svm", "xgboost")
p=pROC::ggroc(discoverset_roc_all) + theme_bw()
p
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter/discoverySetName_roc_all.pdf",p, width=8, height=7)
...
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter/fig_s2_discoverySet.pdf", p_s2, width = 15, height = 8)
...
ROC_allDS=c(discoverset_roc_all[2], ROC_allDS)
p=pROC::ggroc(ROC_allDS) + theme_bw()
p
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter/DiscoverySetName_roc_otherModel.pdf",p, width=8, height=7)
...
write.csv(singledataset_AUC, "07_plotting_v2/02_ITSprediction_metaPlusFilter/discoverySet_otherModel_all.csv", quote = F)
...
write.csv(singledataset_AUC_selected, "07_plotting_v2/02_ITSprediction_metaPlusFilter/discoverset_auc_otherModel.csv", quote = F)
...
ggsave("07_plotting_v2/02_ITSprediction_metaPlusFilter/fig_2ab_discoverySet.pdf", p_fig2ab, width = 15, height = 18)
