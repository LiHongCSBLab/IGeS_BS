...
write.csv(df, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE114601_drug19.csv", quote = F, row.names = F)
...
p2_s=ggplot(data_s, aes(x=variable,y=immunesig_s))+ 
  ...
  theme_bw()+
  ggtitle("GSE114601-SKCM-drug19-JQ1+")
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE114601_drug19.pdf", p2, height = 10, width = 5)
...
df$treated_mouse_binary = sign(df$treated_mouse)
df$treated_cell_binary = sign(df$drugindex)
write.csv(df, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE114601_drug222.csv", quote = F, row.names = F)
...
p2_s=ggplot(data_s, aes(x=variable,y=immunesig_s))+ 
  ...
  scale_fill_gradient2(low = "#6A82FB",mid="grey", high = "#FC5C7D")+
  theme_bw()+
  ggtitle("GSE114601-SKCM-drug222-JQ1-")
...
# p1 + p2 + plot_layout(guides = "auto")  + plot_layout(guides = "collect")
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE114601_drug222.pdf", p2, height = 10, width = 5)
