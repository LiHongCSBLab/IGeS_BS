...
write.csv(df, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825.csv", quote = F, row.names = F)
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825.pdf", p2, height = 10, width = 5)

names(data_s) <-  c("immune_sig", "variable", "value")
names(data_r) <-  c("immune_sig", "variable", "value")
...
p2_all=ggplot(data, aes(x=variable,y=immunesig))+ 
  ...
  theme_bw()+
  ggtitle("GSE149825-SKCM-drug1487-birinapant")
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825_2.pdf", p2_all, height = 5, width = 5)
...
# # p1 + p2 + plot_layout(guides = "auto")  + plot_layout(guides = "collect")
# ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825_SKCM.pdf", p2, height = 10, width = 5)
...
df$treated_mouse_binary = sign(df$treated_mouse)
df$treated_cell_binary = sign(df$drugindex)
write.csv(df, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825_primarySKCM.csv", quote = F, row.names = F)
...
# p1 + p2 + plot_layout(guides = "auto")  + plot_layout(guides = "collect")
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.05/GSE149825_primarySKCM.pdf", p2, height = 10, width = 5)
