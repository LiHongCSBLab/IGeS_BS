...
write.csv(df, "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.1/GSE155923.csv", quote = F, row.names = F)
...
p2_s=ggplot(data_s, aes(x=variable,y=immunesig_s))+ 
  ...
  theme_bw()+
  ggtitle("GSE155923-LUAD-drug196-Everolimus")
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.1/GSE155923.pdf", p2, height = 10, width = 5)



NHWD870_meta_oe_original
