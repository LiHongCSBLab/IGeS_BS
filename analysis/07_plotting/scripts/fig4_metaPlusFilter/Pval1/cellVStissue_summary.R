...
plot_savepath = "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj1/cellVStissue_consistency/"
...
# GSE152925 --------------------------------------------------------------------
file2 = "result_GSE152925/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug888/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
# GSE120500 --------------------------------------------------------------------
file2 = "result_GSE120500/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug53/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
# GSE114601 --------------------------------------------------------------------
file2 = "result_GSE114601/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug19/CellvstreatedMouse.csv"
if(!file.exists(file2)){
  res_immu[[5]] <- data.frame(Var1 = NA, Freq = NA)
}else{
  df = read.csv(file2)
...
file2 = "result_GSE114601/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug222/CellvstreatedMouse.csv"
if(!file.exists(file2)){
  res_immu[[6]] <- data.frame(Var1 = NA, Freq = NA)
}else{
  df = read.csv(file2)
...
file2 = "result_GSE148538/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug170/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
file2 = "result_GSE155923/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug196/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
file2 = "result_GSE33366/letrozole_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug789/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
file2 = "result_GSE33366/tamoxifen_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug1792/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
file2 = "result_GSE33366/bms754807_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug3045/CellvstreatedMouse.csv"
if(!file.exists(file2)){
...
p_valDS_PDX = ggplot( res_PDX, aes( x = factor(dataset), weight = Consistency_ratio, fill = Type))+
  geom_bar( position = "stack")+
  geom_text(aes(label = paste0(round((Consistency_ratio*100),2), "%"), y=Consistency_ratio), 
            position = position_stack(vjust = 0.5), size = 5)+
  coord_flip() +
