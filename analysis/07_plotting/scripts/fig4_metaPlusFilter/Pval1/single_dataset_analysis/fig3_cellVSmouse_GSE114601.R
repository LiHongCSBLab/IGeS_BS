...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj1/GSE114601_drug19.pdf", p2, height = 10, width = 5)
...
# p1 + p2 + plot_layout(guides = 'auto')  + plot_layout(guides = 'collect')
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj1/GSE114601_drug222.pdf", p2, height = 10, width = 5)
