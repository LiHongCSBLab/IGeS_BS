...
file4 = "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug888/CellvstreatedMouse.csv"
df = read.csv(file4)
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj1/GSE152925.pdf", p4_s, height = 10, width = 5)

# v04	GSE152925 swainsonine---------------------------------------------------------
# file4 = "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug888_SKCM/CellvstreatedMouse.csv"
file4 = "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r3_individual_datasets_validation/result_GSE152925/drug_immunesig_TUMERIC_GSEA_result_r0.4_meta_oe_original_en_padj1/drug888/CellvstreatedMouse.csv"
df = read.csv(file4)
df$treated_mouse_binary = sign(df$treated_mouse)
df$treated_cell_binary = sign(df$drugindex)
...
ggsave("/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj1/GSE152925_SKCM.pdf", p4_s, height = 10, width = 5)
