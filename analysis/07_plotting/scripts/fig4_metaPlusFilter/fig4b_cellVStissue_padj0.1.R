...
plot_savepath= "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/fig4b_padj0.1_"

res_savepath  = "/picb/bigdata/project/FengFYM/p2_1_immunotherapy_targetedtherapy/r1_drug_immuneSig_correlation_analysis/07_plotting_v2/04_cellVSmouse_metaPlusFilter/padj0.1/cellVStissue_consistency/"
res <- read.csv(paste0(res_savepath, "cellVStissue_summary.csv"))

res_immu = res[res$mousetype == 'withImmuneSystem', ]
res_immu = res_immu[is.element(res_immu$dataset, c('GSE149825_priSKCM', 'GSE152925', 'GSE120500', 'GSE160785_COAD', 'GSE114601_jq+')), ]
...
ggsave(paste0(plot_savepath, "cellVStissue_summary_immuneCompetentMice.pdf"), p_valDS_immu , width = 10, height = 6)
