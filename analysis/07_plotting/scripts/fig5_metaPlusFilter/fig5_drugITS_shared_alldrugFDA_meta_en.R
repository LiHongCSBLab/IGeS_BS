...
dir.create("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/sharedDrug_metaPlusFilter_alldrugFDA/")
...
for(f in filenames){
    ...
    ggsave(filename = paste0("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/sharedDrug_metaPlusFilter_alldrugFDA/", gsub("_res.txt", "",f), "_70138.pdf"), width = 15, height = 15)
    ...
    ggsave(filename = paste0("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/sharedDrug_metaPlusFilter_alldrugFDA/", gsub("_res.txt", "",f), "_92742.pdf"), width = 20, height = 30)
    ...
    ggsave(filename = paste0("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/sharedDrug_metaPlusFilter_alldrugFDA/", gsub("_res.txt", "",f), ".pdf"), width = 20, height = 30)
