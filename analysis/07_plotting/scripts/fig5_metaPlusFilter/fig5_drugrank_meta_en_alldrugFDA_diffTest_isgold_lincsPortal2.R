...
set.seed(1234)
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/')
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/70138/')
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/92742/')
...
for(f in filenames){
  #  f=filenames[1]
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/70138/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/70138/', gsub("_res.txt","", f),'/')
  ...
  for(i in 1:length(resfilepath)){
    ...
    for(proofType in c(cancer, 'FDA', 'ClinicalTrial_III', 'ClinicalTrial_beforeIII','ClinicalTrial_afterIII', 'proof')){
      ...
      if(length(unique(res_fda$label))>1){
        ...
        res_fda2 <- res_fda1[is.element(res_fda1$drugname_lower, unique(drug_maxfda34$drugname_lower)), ]
...
for(f in filenames){
  ...
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/92742/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/92742/', gsub("_res.txt","", f),'/')
...
# 70138
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/70138/'
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/70138/')

  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/70138/', f,'/')
...
# 92742
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA/92742/'
filenames <- list.files(filepath)
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/92742/')

  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/92742/', f,'/')
  dir.create(ressavepath)
...
for(i in seq(length(filenames))){
  ...
  # plot
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_isgold_lincsPortal2_metaPlusFilter_alldrugFDA_summary/', f,'/')
  dir.create(ressavepath)
