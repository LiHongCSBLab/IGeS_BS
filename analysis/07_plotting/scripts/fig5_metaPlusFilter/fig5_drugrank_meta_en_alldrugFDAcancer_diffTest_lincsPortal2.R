...
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/')
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/70138/')
dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/92742/')
...
for(f in filenames){
  ...
  #  f=filenames[3]
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/70138/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/70138/', gsub("_res.txt","", f),'/')
  ...
  for(i in 1:length(resfilepath)){
    ...
    res_weighted_en$drugname_lower = tolower(res_weighted_en$pert_iname)
    ...
    for(proofType in c(cancer, 'FDA', 'ClinicalTrial_III', 'ClinicalTrial_beforeIII','ClinicalTrial_afterIII', 'proof')){
      ...
      if(length(unique(res_fda$label))>1){
        ...
        res1 = unique(unique(rbind(tmp1, tmp2)))
        ...
        res_fda2 <- res_fda[is.element(res_fda$drugname_lower, unique(drug_FDAcancer$drugname_lower)), ]
        ...
        res2 = unique(unique(rbind(tmp1, tmp2)))
        ...
        if(nrow(res2[res2$label == 'others',])>1) {plot(density(res2[res2$label == 'others',]$score), main='FDAcancer_filterMoA')}else{
            if(nrow(res2[res2$label == 'fda_combo',])>1) plot(density(res2[res2$label == 'fda_combo',]$score), col = 'red')
        }
  ...
  res70138_SKCMprimary$drugname_lower = tolower(res70138_SKCMprimary$pert_iname)
  ...
  cancer = "SKCM"
  for(proofType in c('SKCM', 'FDA', 'ClinicalTrial_III', 'ClinicalTrial_beforeIII','ClinicalTrial_afterIII', 'proof')){
    
    res_fda <- res70138_SKCMprimary # [is.element(res_weighted_en$pert_iname, drug_FDAcancer$drugname_lower), ]
    res_fda$label = 'others'
    ...
    if(length(unique(res_fda$label))>1){
      ...
      res_fda2 <- res_fda1[is.element(res_fda1$drugname_lower, unique(drug_FDAcancer$drugname_lower)), ]
      # res_fda2$drugname_lower <- res_fda2$pert_iname
      res_fda2 <- res_fda2[order(res_fda2$score, decreasing = T), ]
...
for(f in filenames){
  ...
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/92742/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/92742/', gsub("_res.txt","", f),'/')
  ...
  res92742_SKCMprimary$drugname_lower = tolower(res92742_SKCMprimary$pert_iname)
...
# 70138
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/70138/'
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/70138/')
  
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/70138/', f,'/')
...
# 92742
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer/92742/'
filenames <- list.files(filepath)
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/92742/')
  
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/92742/', f,'/')
  dir.create(ressavepath)
...
for(i in seq(length(filenames))){
  ...
  res70138$dataset = '70138'
  res92742$dataset = '92742'
  res = rbind(res70138, res92742)

  # plot
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_alldrugFDAcancer_summary/', f,'/')
  dir.create(ressavepath)

  lapply(as.list(unique(res$index)), function(x){
    
    pdata = res[res$index == x,]
     p= lapply(as.list(unique(res$shape)), function(y){
      
      pdata2 = pdata[pdata$shape == y, ]
      p = ggplot(data = pdata2, aes(x=effectsize, y= -log10(pval), colour=cancer, fill=shape, shape = dataset)) + 
