...
for(f in filenames){
  ...
  #  f=filenames[1]
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/70138/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/70138/', gsub("_res.txt","", f),'/')
...
for(f in filenames){
  ...
  dir.create(paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/92742/', gsub("_res.txt","", f)))
  savepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/92742/', gsub("_res.txt","", f),'/')
...
# 70138
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/70138/'
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/70138/')
  
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/70138/', f,'/')
...
# 92742
filepath <- '07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter/92742/'
filenames <- list.files(filepath)
...
for(i in seq(length(filenames))){
  ...
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/')
  dir.create('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/92742/')
  
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/92742/', f,'/')
  dir.create(ressavepath)
...
for(i in seq(length(filenames))){
  ...
  # plot
  ressavepath = paste0('07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugrank_diff_lincsPortal2_metaPlusFilter_summary/', f,'/')
  dir.create(ressavepath)
  ...
  lapply(as.list(unique(res$index)), function(x){
    ...
    p2 = (p[[1]]+p[[2]]) / (p[[3]] + p[[4]]) / (p[[5]]+p[[6]])
    ggsave(paste0(ressavepath, x, ".pdf"), p2 , width = 17, height = 20)
  })
