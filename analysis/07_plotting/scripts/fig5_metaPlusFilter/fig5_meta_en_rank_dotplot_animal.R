...
dir.create("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_dotplot_animal/")
...
for(f in filenames){
  ...
  for(cancer in cancerlist){
    ...
    # filenames <- list.files("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_dotplot_animal/")
    # drugrank <- read.csv("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_dotplot_animal/meta_en_ACATP0.05_meta_weight_weighted_sum_mean_res.txt", sep = '\t', header = T)
    ...
    ggsave(paste0("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_dotplot_animal/", gsub("_res.txt", "", f), "_", cancer, "_",dataset, ".pdf"), 
