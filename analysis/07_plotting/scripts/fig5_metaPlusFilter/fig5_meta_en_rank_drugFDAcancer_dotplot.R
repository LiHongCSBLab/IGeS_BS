...
dir.create("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_drugFDAcancer_dotplot/")
...
for(f in filenames){
  ...
  for(cancer in cancerlist){
    ...
    # filenames <- list.files("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_drugFDAcancer_dotplot/")
    # drugrank <- read.csv("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_drugFDAcancer_dotplot/meta_en_ACATP0.05_meta_weight_weighted_sum_mean_res.txt", sep = '\t', header = T)
    ...
    # dat <- drugrank[is.element(drugrank$drug_index, drug_maxfda34$drug_index), ]
    dat <- drugrank[is.element(drugrank$pert_iname, unique(drug_FDAcancer$drugname_lower)), ]
    ...
    ggsave(paste0("07_plotting_v2/05_drugITSprofiler_CombatRef_metaPlusFilter/drugITSres_metaPlusFilter_drugFDAcancer_dotplot/", gsub("_res.txt", "", f), "_", cancer, "_",dataset, ".pdf"), 
